export function buildQuinnCorePrompt(mode) {
...
export function getQuinnGreeting(mode, totalQuestions) {
    if (mode === 'SUPPORTIVE') {
...
export function getQuinnFeedbackIntro(mode, score) {
    if (mode === 'SUPPORTIVE') {
        if (score >= 80)
...
export function getQuinnHintIntro(mode) {
    if (mode === 'SUPPORTIVE') {
...
export function getQuinnCompletionMessage(mode) {
    if (mode === 'SUPPORTIVE') {
