...
interface EvaluationInput {
    ...
    voiceMetrics?: { confidence?: number; pace?: number; fillers?: number }; // Optional
    videoMetrics?: { eyeContact?: number; posture?: number }; // Optional
}
...
`;
    ...
    try {
        ...
        const parsed = await provider.generateJson<any>(prompt, { temperature: 0.4, maxOutputTokens: 1024 });
